...
[`certified-release` job](https://github.com/BargLabs/cejel-certified-release-example/blob/29c019635f09c9c0cb06538f5e0db21906443298/.github/workflows/certified-release.yml)
...
to released version `0.4.5`; no local or internal engine copy was used.
...
| Evidence | Value |
|---|---|
| Workflow run | [32892393150](https://github.com/BargLabs/cejel-certified-release-example/actions/runs/32892393150) |
| Source commit | `29c019635f09c9c0cb06538f5e0db21906443298` |
...
| Cejel report SHA-256 | `77d45f3792670cba3ca820f5a5f15ab6ed4071dac2758b740205b3caee3deaab` |
| Cejel action version | `0.4.5` |
...
The example is deliberately small. Its Cejel verdict is `at_risk` at `1.6/4.0`; the provenance
binding does not change, improve, or endorse that verdict. Here, “certified commit” means the
commit identified by the Cejel certificate, not a promise of a particular score.
...
expected_commit=29c019635f09c9c0cb06538f5e0db21906443298
expected_artifact_sha256=5c6b0f50678f92929a276af903baeee23aaba7e6963794500d93041b8367b420
expected_report_sha256=77d45f3792670cba3ca820f5a5f15ab6ed4071dac2758b740205b3caee3deaab
...
jq -e --arg commit "$certified_commit" --arg report_sha "$expected_report_sha256" '
  .predicate.tool == {"name":"cejel","version":"0.4.5"} and
