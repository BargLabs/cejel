...
- Run date: 2026-07-20T13:12:56.894Z
- Cejel version: @cejel/cejel@0.1.7 (7722553e1146)
...
- Every score on this board is produced by the sealed public scorer used by `npx @cejel/cejel .`; no private domain collector contributes. Public-repository rows pin an immutable public commit and are independently reproducible from it. The two explicitly labeled private transparency snapshots are not independently reproducible because their source commits and evidence locations are not public; they are not public-repository self-scores.
...
- The whole corpus membership is published and sorted by score. It includes two labeled private transparency snapshots, not a score of this public repository. A repository that fails to clone or score appears as a loud ERROR row with the reason — it is never silently dropped, and it is retried on the next run.
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| [cejel source sub-package (private snapshot)](reports/cejel.md) | internal-tool | AGPL-3.0-only | 3.4 | 3.4 | 2.7 | 4.0 | code 4/5 · process 1/6 · **low confidence** | 2 | Conditional | ![cejel badge](reports/cejel-badge.svg) | [certificate](reports/cejel.html) · [report](reports/cejel.md) · [json (machine-readable)](reports/cejel.json) | private source commit unavailable publicly; scored on 5 of 11 dimensions — too few to rank |
