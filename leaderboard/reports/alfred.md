...
|---|---|---|---:|---|---|
| A1 | Test integrity and regression signal | Code trust | 2.3 | warning | Test-to-source file ratio: 355 ratio (cap 624); Static coverage percentage: 0/100 percent; Verification script ratio: 4 ratio (cap 4); Non-hollow test share: 351/355 ratio |
...
| A3 | Production readiness | Code trust | 2.9 | info | Production-readiness primitive coverage: 3/6 primitives; Production workflow depth: 26 signals (cap 6); Observability depth: 95 signals (cap 4); Rollback and migration-safety depth: 116 signals (cap 4) |
