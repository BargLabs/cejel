...
|---|---|---|---:|---|---|
| A1 | Test integrity and regression signal | Code trust | 2.3 | warning | Test-to-source file ratio: 353 ratio (cap 624); Static coverage percentage: 0/100 percent; Verification script ratio: 4 ratio (cap 4); Non-hollow test share: 350/353 ratio |
...
| A3 | Production readiness | Code trust | 2.9 | info | Production-readiness primitive coverage: 3/6 primitives; Production workflow depth: 26 signals (cap 6); Observability depth: 94 signals (cap 4); Rollback and migration-safety depth: 116 signals (cap 4) |
...
- A2: Committed secret-shaped value (path withheld — private repository, sha256:213989426f8b) (info)
...
- B4: Audit or changelog artifact (path withheld — private repository, sha256:15f07ce24aa0)
...
- B6: CODEOWNERS/required-review gate on protected paths (path withheld — private repository, sha256:15f07ce24aa0)
...
- A2 info: Secret-shaped value in a test/fixture file (path withheld — private repository) — likely fixture data, not a production leak; verify. (Committed secret-shaped value (path withheld — private repository, sha256:213989426f8b))
