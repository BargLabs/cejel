...
- Generated: 2026-07-27T01:48:38.955Z
- Repository: . @ ed2aa67323ac06190d6c2a9ecb2da3de6dd6c75d

## Criterion Profile

| ID | Criterion | Category | Score | Status | Measurement signals |
|---|---|---|---:|---|---|
| A1 | Test integrity and regression signal | Code trust | 2.3 | verified | Test-to-source file ratio: 403/657 ratio; Static coverage percentage: 0/100 percent; Verification script ratio: 4/4 ratio; Non-hollow test share: 400/403 ratio |
| A2 | Data-layer isolation and secrets posture | Code trust | 2.4 | verified | Secret cleanliness: 1/1 clean; Environment handling depth: 3/3 practices; RLS policy count: 6/38 policies; Tenant-scoped schema ratio: 38/49 ratio |
...
| B2 | PR outcome traceability | Process trust | 3.8 | verified | PR trace primitive coverage: 2 signals (capped; 27 raw); Recent PR merge ratio: 9/12 ratio |
...
- A2: Repository-native RLS scope (studio_id) (path withheld — private repository, sha256:253c372ea48d)
...
- B4: Audit or changelog artifact (path withheld — private repository, sha256:86aa0b4e8154)
...
- B6: CODEOWNERS/required-review gate on protected paths (path withheld — private repository, sha256:86aa0b4e8154)
