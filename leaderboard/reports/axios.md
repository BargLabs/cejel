...
- A1 finding severity info (dimension band verified): Test suite files are present, but no coverage configuration was detected. (Detected test file (tests/browser/adapter.browser.test.js:1, sha256:11b993b6139f))
