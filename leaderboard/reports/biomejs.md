...
|---|---|---|---:|---|---|
| A1 | Test integrity and regression signal | Code trust | 2.2 | verified | Test-to-source file ratio: 4099 ratio (capped; 7395 raw); Static coverage percentage: 0/100 percent; Verification script ratio: 2/4 ratio; Non-hollow test share: 242/268 ratio |
...
| B2 | PR outcome traceability | Process trust | 4.0 | verified | PR trace primitive coverage: 2 signals (capped; 27 raw); Recent PR merge ratio: 1/1 ratio |
...
| B6 | Privileged-operation human gating | Process trust | 1.7 | verified | Human gate documented: 0/1 present; Fail-closed privilege check present: 0/1 present; Privilege-escalation cleanliness: 1/1 clean; Protected-path review gate: 1/1 present |
