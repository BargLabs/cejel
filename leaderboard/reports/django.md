...
- Not applicable: A3, A5, B1, B4, B5, B6 — substrate-specific criteria excluded from composite (N/A for external code).
...
- A1: Detected test file (django/test/__init__.py:1, sha256:5f5d82f7c94a) (info)
- A2: Data layer migration (django/conf/app_template/migrations/__init__.py-tpl)
- A2: Data layer migration (django/conf/app_template/migrations/__init__.py-tpl) (warning)
